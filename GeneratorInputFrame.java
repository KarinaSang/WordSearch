...
public class GeneratorInputFrame extends JFrame implements ActionListener{
  ...
  public static void main(String[] args){
   GeneratorInputFrame inputFrame = new GeneratorInputFrame(); 
  }
